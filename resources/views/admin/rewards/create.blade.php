...
@section('content')
    <div class="max-w-3xl mx-auto space-y-6">
        ...
        <div class="flex items-center justify-between">
            <div>
                <h1 class="text-2xl font-bold text-gray-900 dark:text-white">Tambah Reward Baru</h1>
                <p class="text-gray-600 dark:text-gray-400">Tambahkan produk baru ke marketplace.</p>
            </div>
        ...
        <div class="bg-white dark:bg-gray-800 rounded-xl shadow-sm border border-gray-200 dark:border-gray-700 p-8">
            <form action="{{ route('admin.rewards.store') }}" method="POST" enctype="multipart/form-data" class="space-y-6">
                @csrf
                ...
                <div>
                    ...
                    <select name="category" id="category" required
                        class="w-full px-4 py-2 rounded-lg border border-gray-300 dark:border-gray-600 dark:bg-gray-700 dark:text-white focus:ring-teal-500 focus:border-teal-500">
                        <option value="Voucher" {{ old('category') == 'Voucher' ? 'selected' : '' }}>Voucher</option>
                        ...
                        <option value="Pulsa/Token" {{ old('category') == 'Pulsa/Token' ? 'selected' : '' }}>Pulsa/Token
                        </option>
                ...
                <div>
                    <label for="description"
                        class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-2">Deskripsi Produk</label>
                    <textarea name="description" id="description" rows="3" required
                        class="w-full px-4 py-2 rounded-lg border border-gray-300 dark:border-gray-600 dark:bg-gray-700 dark:text-white focus:ring-teal-500 focus:border-teal-500"
                        placeholder="Jelaskan detail produk secara singkat...">{{ old('description') }}</textarea>
                    @error('description')
                        <p class="text-red-500 text-sm mt-1">{{ $message }}</p>
                    @enderror
                </div>
                ...
                <!-- Poin -->
                <div>
                    <label for="poin_required" class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-2">Poin
                        Dibutuhkan</label>
                    <div class="relative">
                        <input type="number" name="poin_required" id="poin_required" value="{{ old('poin_required') }}"
                            required min="1"
                ...
                <!-- Gambar -->
                <div>
                    <label for="image" class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-2">Gambar
                        Produk</label>
                    <div
                        ...
                        <div class="space-y-1 text-center">
                            ...
                            <div class="flex text-sm text-gray-600 dark:text-gray-400">
                                <label for="image"
                                    class="relative cursor-pointer bg-white dark:bg-gray-800 rounded-md font-medium text-teal-600 hover:text-teal-500 focus-within:outline-none focus-within:ring-2 focus-within:ring-offset-2 focus-within:ring-teal-500">
                ...
                <div class="flex items-start">
                    ...
                    <div class="ml-3 text-sm">
                        ...
                        <p class="text-gray-500 dark:text-gray-400">Jika tidak dicentang, produk tidak akan muncul di
                            marketplace user.</p>
                    </div>
                </div>
